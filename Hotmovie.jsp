...
<head>
    ...
    <style>
        ...
        @import url(assets/css/Hotmovie.css);
    </style>
</head>
    ...
    <div id="main">
        ...
        <section>
            <div class="hot_section">
                <div class="hot_background">
                    <img src="assets/img/table.jpg" style="height:100%;width:100%;">
                </div>
                <div class="hot_rank">
                    <div class="hot_poster">
                        <div class="hot_img1">
                        <%
                           
                        %>
                            <a href=""><img src="assets/img/spiderman.png" style="height:100%;width:100%;"></a>
                        </div>
                        <div class="hot_text">
                            ≋2≋
                        </div>
                    </div>
                    <div class="hot_poster1">
                        <div class="hot_img1">
                            <a href=""><img src="assets/img/doctorstrange.png" style="height:100%;width:100%;"></a>
                        </div>
                        <div class="hot_text">
                            ≋1≋
                        </div>
                    </div>
                    <div class="hot_poster2">
                        <div class="hot_img1">
                            <a href=""><img src="assets/img/purelove.png" style="height:100%;width:100%;"></a>
                        </div>
                        <div class="hot_text">
                            ≋3≋
                        </div>
