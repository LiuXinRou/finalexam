                ...
                <div class="login">
                    ...
                    <form method="POST" action="check.jsp">
                        ...
                        <div class="login_Account">
                            <input type="text" placeholder="Account" name="id">
                        </div>
                        <!--pwd-->
                        <div class="login_Account">
                            <input class="" type="password" placeholder="••••••••••••••" name="pwd">
                        </div>
            
                        <!--forget-->
                        <div class="forget">
                            <a href="" style="text-decoration: none;color:rgb(8, 8, 8);">Forgot username or password?</a>
                        </div>
            
                        <!--signup-->
                        <div class="signup">
                            <a href="signup.jsp" style="text-decoration: none;color:rgb(8, 8, 8);">Sign up</a>
                        </div>
