            ...
            <div class="signup">
                    ...
                    <form method="POST" action="signin.jsp">
                        ...
                        <div class="signup_Account">
                            <input class="name" type="text" name="id"  placeholder="Username">
                        </div>
                        
                        <!--email-->
                        <h3>電子信箱</h3>
                        <div class="signup_Account">
                            <input class="name1" type="text" name="email" placeholder="xxx@gmail.com">
                        </div>
                        
                        <!--pwd-->
                        <h3>密碼</h3>
                        <div class="signup_Account">
                            <input id="password" type="text" name="pwd" placeholder="••••••••••••••" onclick="checkpassword()"><br>
                        </div>    
        
                        <!--phone-->
                        <h3>手機號碼</h3>
                        <div class="signup_Account">
                            <input class="name" type="text" name="phone" placeholder="xxxx-xxx-xxx">
                        </div>
                        
                        <h3>聯絡地址</h3>
                        <div class="signup_Account">
                            <input class="name" type="text" name="address" placeholder="xx市-xx區-xx路">
                        </div>
