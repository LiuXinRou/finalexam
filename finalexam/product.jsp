            ...
            <div class="pd_section">
                ...
                <div class="pd_section1">
                    <div class="pd_section1_poster">
                        ...
                        <%
                            while(rs.next()){
                            out.println("<form action='good-1.jsp'>");
                            out.println("<div class='poster'>");   
                            out.println("<div class='poster_img'>");
                            out.println("<input type='image' src='"+rs.getString(6)+"' style='height:100%;width:100%'>");
                            out.println("</div>");
                            out.println("<div class='poster_text1'>");
                            out.println(rs.getString(1));
                            out.println("</div>");
                            out.println("<div class='poster_text2'>");
                            out.println("日租金額 : <span>$"+rs.getString(3)+"</span><br>");
                            out.println("庫存:"+rs.getString(7)+"");
                            out.println("</div>");
                            out.println("<input type='hidden' name='pid' value='"+rs.getString(2)+"'>");
                            out.println("</form>");
                            out.println("</div>");
                            }
                        %>
