...
<body>
    <div id="main">
            ...
            <div id="logo">
                ...
                <h1><a href="index.html" style="color:white;">電影宅急便</a></h1>
                    <div id="header_nav2">
                        ...
                        <a href="Hotmovie.html"><div id="h_nav2_text2"><img src="img/fire.png" class="h_nav2_icon">近期熱門</div></a>
                        <a href="product.jsp"><div id="h_nav2_text2"><img src="img/film.png" class="h_nav2_icon">所有電影</div></a>
                        <a href="car.html"><div id="h_nav2_text2"><img src="img/film.png" class="h_nav2_icon">我的片單</div></a>
                        <a href="login.html"><span id="h_nav2_text2" style="background: none;border: none;"><img src="img/user.png" class="h_nav2_icon">登入/註冊</span></a>   
                    </div>
                ...
                <div id="header_nav1">
                    ...
                    <div id="h_nav1_text">
                        ...
                        <a href="member.html"><p id="h_n_text_2"><img src="img/user.png" class="h_nav2_icon">會員中心</p></a><hr>
                        <a href="Hotmovie.html"><p id="h_n_text_2" style="margin-top:30px;"><img src="img/fire.png" class="h_nav2_icon">近期熱門</p></a>
                        ...
                        <a href="car.html"><p id="h_n_text_2"><img src="img/film.png" class="h_nav2_icon">我的片單</p></a>
                        <a href="about.jsp"><p id="h_n_text_2"><img src="img/user.png" class="h_nav2_icon">關於我們</p></a>
                        <a href="login.html"><p id="h_n_text_2" style="margin-top:40%;"><img src="img/user.png" class="h_nav2_icon">登入</p></a>                     
                    </div>
                </div>
            </div>
        </div>
	    ...
	    sql1="SELECT * FROM perflim WHERE `product_id`='"+n+"'";
	    con1.createStatement().execute(sql1);
	    ResultSet rs=con1.createStatement().executeQuery(sql1);
                    ...
                    <div class="good">
                        ...
                        <div class="good_text1">
                            <div class="good_title">
                                <h1 class="good_title1">🎞<%=(rs.getString(1))%></h1>
                                <p class="good_title2"><%=(rs.getString(17))%></p>
                            </div>
                        ...
                        <div class="introduce2">
                            ...
                            <div class="introduce2_text2">
                                ...
                                <div class="introduce_text2_article">
                                    <%=(rs.getString(15))%>
                                </div>
                            </div>
                        </div>
                        ...
                        <%
                            ...
                            //Step 4: 執行 SQL 指令, 若要操作記錄集, 需使用executeQuery, 才能傳回ResultSet	
                                    ...
                                    for(int i=1;i<=page_num;i++) //建立1,2,...頁超連結
                                        out.print("<a href='good-1.jsp?n="+n+"&page="+i+"'>"+i+"</a>&nbsp;"); //&nbsp;html的空白
                            ...
                            //Step 5: 顯示結果 
                                    ...
                                    //遞減排序, 讓最新的資料排在最前面
                                    sql3="SELECT * FROM `content` where `flim_name`= '"+(rs.getString(1))+"' ORDER BY `flim_name` DESC LIMIT ";
                                    sql3+=start_record+",2";
                                            ...
                                            { %>
                                                <div class="comment_text">
                                                    <div class="comment_text_img">
                                                        <img src="img/user.png" style="width:60px;height:60px;display: block;margin: auto;">
